...
function render(data) {
    var html = "<div class='itemBox'><div class='leftPanelImg'><img src='http://via.placeholder.com/100x100'><input type='button' id='apply' value='Aplicar a Reto'></div><div class='rightPanel'><h5>" + data.name + "</h5><p>" + data.body + "</p></div><div class='clear'></div></div>";
    $('#container').append(html);
}

$(document).ready(function () {
    $('#addNewCh').click(function () {
        var addObj = {
            "name": $('#name').val(), "body": $('#bodyText').val()
        };
        console.log(addObj);
        retos.push(addObj);
        render(addObj);
